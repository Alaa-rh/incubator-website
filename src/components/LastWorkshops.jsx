...
// import { useGetLatestWorkshopsQuery } from '../../api/endpoints/workshopsApi'; // TODO: اشتغل بعد الربط

const LastWorkshops = () => {

    // const { data: workshops = [], isLoading, error } = useGetLatestWorkshopsQuery();

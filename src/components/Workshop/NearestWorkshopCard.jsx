  ...
  return (
    <div className='bg-white p-6 rounded-lg flex justify-between items-center shadow-lg mb-8'>
         <div>
            ...
            <p className='font-medium'><span className='font-bold text-xl pl-4'>اسم الورشة :</span>{workshop.name}</p>
            <p className='font-medium'><span className='font-bold text-xl pl-4'>تبدأ بتاريخ :</span>{workshop.startDate}</p>

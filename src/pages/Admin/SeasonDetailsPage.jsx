...
const SeasonDetailsPage = () => {
  const season = {
    ...
    statusType: "open", // open | evaluation | camp | finished
    applications: 30,
    remainingDays: 3,
    startDate: "2025/2/10",
    endDate: "2025/2/10",
  ...
  const showForm = season.statusType === "open"; // فقط أثناء التقديم
  const showReview = season.statusType !== "finished"; // كل الحالات ما عدا المنتهي
  ...
  return (
    ...
    <div className="container">
      ...
      {activeTab === "review" && showReview && (
        <ApplicationsReview season={season} applications={applications} />
      )}
    </div>
    </div>
  );
